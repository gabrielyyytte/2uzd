...
label:
        int a;
        std::cout << "Jei norite namu darbu rezultatus ivesti patys parasykite 0, parasius bet kuri kita skaiciu programa rezultatus sugeneruos automatiskai:" <<std::endl;
        std::cin >> a;
        if (a==0)
        {
...
label2:
        int e;
        std::cout << "Jei norite egzamino rezultata ivesti patys parasykite 0, parasius bet kuri kita skaiciu programa rezultata sugeneruos automatiskai:" <<std::endl;
        std::cin >> e;
        if (e==0)
        {
